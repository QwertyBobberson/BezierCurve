...
{
public:
	void Run(std::vector<Vertex> vertices, std::vector<uint32_t> _indices)
	{
		verts = vertices;
		indices = _indices;
		InitWindow();
...
private:
	...
	void CreateTextureImage()
	{
		...
		stbi_uc* pixels = stbi_load("test2.png", &width, &height, &channels, STBI_rgb_alpha);
		// PNG img = ReadPng("test2.png");
